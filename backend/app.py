...
def receive_car():
    ...
    if old_status in ["normal", "warning", "danger"] and new_status in ["warning", "danger"] and new_status != old_status:
        ...
        payload = {
            ...
            "old_status": status_translated.get(old_status, old_status),
            "new_status": status_translated.get(new_status, new_status),
            "date": ttime
        }
